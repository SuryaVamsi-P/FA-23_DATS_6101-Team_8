...
# Question 4: Among different age groups (children, adults, and senior citizens), which demographic exhibits the highest mortality rate?
...
```
# Question 5: Can the presence of medical conditions like diabetes, hepatic failure, or other medical conditions impact an individual's likelihood of mortality?
```{r}
data$diabetes_mellitus <- as.factor(data$diabetes_mellitus)
data$hepatic_failure <- as.factor(data$hepatic_failure)
model <- glm(hospital_death ~ diabetes_mellitus + hepatic_failure, data = data, family = "binomial")
